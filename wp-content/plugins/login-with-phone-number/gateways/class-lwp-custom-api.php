...
class LWP_CUSTOM_Api
{
    ...
    public function __construct()
    {
        ...
        if (!isset($options['drc_custom_api_method'])) $options['drc_custom_api_method'] = 'GET';
        if (!isset($options['drc_custom_api_smstext'])) $options['drc_custom_api_smstext'] = '';
        $this->header = $options['drc_custom_api_header'];
        $this->body = $options['drc_custom_api_body'];
        $this->url = $options['drc_custom_api_url'];
        $this->method = $options['drc_custom_api_method'];
        $this->smstext = $options['drc_custom_api_smstext'];
    }
