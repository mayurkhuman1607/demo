...
[Login with phone number documentations](https://drc.com/product/login-with-phone-number-in-wordpress/ "login & register with phone number")
...
1. use  [drc_lwp] shortcode in your posts and pages where you need user to be logged in
1. use  [drc_lwp_metas nicename="false" username="false" phone_number="true" email="false"] where you want to show logged in users metas. for example you can use this shortcode in user's profile page. you can show phone number, email, username and nicename.
...
= 1.2.23 = 
remove default option drc_use_custom_gateway 
...
add new shortcode [drc_lwp_metas nicename="false" username="false" phone_number="true" email="false"]
