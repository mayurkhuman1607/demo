if(window.makecrispactivate) {
    ...
    function return_answer(c) {
        ...
        switch (c) {
            case 'How should I config plugin to work?':
                return 'For sending messages or One-Time-Password SMS, config firebase like here:'+"\n"+'https://drc.com/?p=3300 '+"\n"+'then create a page, put [drc_lwp] inside it, publish it and check it in other browser, or incognito mode or where you are not logged in!';
                break;
            ...
            case 'I am not receiving OTP!':
                ...
                break;
            case 'I used [drc_lwp] shortcode and created a page, but I am not seeing any login form!':
    ...
    function sendFirstQuestions() {
        $crisp.push(["do", "message:show", ["picker", {
            ...
            "choices": [
                ...
                {
                    "value": "4",
                    "label": "I used [drc_lwp] shortcode and created a page, but I am not seeing any login form!",
                    "selected": false
                },
                // {
                //     "value": "5",
    ...
    window.CRISP_READY_TRIGGER = function () {
        ...
        jQuery(document).ready(function () {
            ...
            wehavelink.attr('href', 'https://drc.com');
            wehavelink.html('supported by '+'<span style="">drc.com</span>');
